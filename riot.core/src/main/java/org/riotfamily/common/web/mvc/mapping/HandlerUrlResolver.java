 ...
 * @since 6.5
 */
public class HandlerUrlResolver implements ApplicationContextAware, HandlerUrlResolverIntf {

	private HandlerUrlResolverIntf parent;

	private ApplicationContext applicationContext;
	
	private List<ReverseHandlerMapping> reverseMappings;
	
	public void setParent(HandlerUrlResolverIntf parent) {
		this.parent = parent;
	}
